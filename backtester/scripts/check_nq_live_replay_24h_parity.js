...
const fixturePath = path.resolve(__dirname, "../fixtures/nq_live_replay_24h_parity_fixture.json");
...
function replay24hSummary(output) {
  ...
  return {
    ...
    warnings_affecting_confidence: Array.isArray(output.warnings) ? output.warnings : []
  };
}
...
function main() {
  ...
  console.log("");
  console.log("Replay output matches the frozen live NQ 24H output for the primary snapshot.");
